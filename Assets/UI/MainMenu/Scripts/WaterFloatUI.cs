...
public class WaterFloatUI : MonoBehaviour
{
    //public properties
    ...
    {
        //get components
        WavesUI = FindObjectOfType<WavesUI>();
    ...
    void FixedUpdate()
    {
        ...
        for (int i = 0; i < FloatPoints.Length; i++)
        {
            //height
            WaterLinePoints[i] = FloatPoints[i].position;
            WaterLinePoints[i].y = WavesUI.GetHeight(FloatPoints[i].position);
